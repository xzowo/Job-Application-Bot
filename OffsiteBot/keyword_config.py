...
PREFIX_PATH = '..\\IndeedBot\\'
OFFSITE_LINKS_FNAME = PREFIX_PATH + 'offsite_links.json'
COMMON_KEYWORD_OMISSIONS_FNAME = PREFIX_PATH + 'common_keyword_omissions.json'
RESUME_PATH = "C:\\Users\\anon\\Desktop\\misc\\Resume.doc"
...
HIGHEST_PRIORITY_PHRASES_FNAME = PREFIX_PATH + 'highest_priority_phrases.json'
PROFILE_KEYWORD_PHRASES_FNAME = PREFIX_PATH + 'profile_keyword_phrases.json'
PROFILE_KEYWORD_WORDS_FNAME = PREFIX_PATH + 'profile_keyword_words.json'
COMMON_KEYWORD_PHRASES = PREFIX_PATH + 'common_keyword_phrases.json'
